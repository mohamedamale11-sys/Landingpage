...
function LogoMarkSmall() {
  return (
    <div className="grid h-8 w-8 place-items-center overflow-hidden rounded-xl border mx-hairline bg-white/[0.02]">
      ...
      <div className="mx-container py-12">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-[1.3fr_1fr_1fr]">
          <div className="min-w-0">
            ...
            <p className="mt-4 max-w-[54ch] text-[14px] leading-relaxed text-white/65">
              Wararka crypto ee af-Soomaali, degdeg oo nadiif ah. Waxaan diiradda
              saarnaa warar la fahmi karo, habaysan, oo ku habboon bulshada Soomaaliyeed.
            </p>
          ...
          <div>
            ...
            <div className="mt-3 flex flex-col gap-2 text-[13px] text-white/70">
